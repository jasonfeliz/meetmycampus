...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2018 at 06:31 PM
...
INSERT INTO `collegeList` (`college_id`, `uni_name`, `city`, `state`, `email_url`, `uni_abrev`) VALUES
...
INSERT INTO `collegestudent` (`id`, `firstName`, `lastName`, `username`, `email`, `token`, `verified`, `dateSignedUp`, `collegeId`) VALUES
(35, 'jason', 'feliz', 'arkham', 'arkham@harvard.edu', '$2y$10$KThv2Ly1HG4/suvsfj0EPuyKbRzzGSASZuubO.m1PFzLSNMmk3aVC', 'yes', '2017-11-22 02:38:40', 227),
(36, 'mike', 'jordan', 'mikejordan', 'mj@unc.edu', '$2y$10$z6C2J3w6/M6cwCRNbIU9ZOjmFWfPGsENua24Boro9wgKtPZDxiose', 'yes', '2017-11-22 13:23:35', 598),
(37, 'Nathan', 'Miranda', 'brandnate', 'nate@harvard.edu', '$2y$10$xuezjjtws2ZraNX4c1NwouqMlA2c2zPGMuU.U7PetUuJ50sgCr5lO', 'yes', '2017-12-12 15:06:03', 227),
(38, NULL, NULL, 'Anonymous', NULL, NULL, 'yes', '2018-01-08 18:52:30', NULL),
(39, 'Reggie', 'Miller', 'rmiler294333', 'rmiller@harvard.edu', '$2y$10$l7w4i6GwVQpYDNwfxHsFseHxGl7zhG631oy86VSd3fKWenW7AH.wa', 'no', '2018-03-14 01:24:11', 227),
(40, 'Mark', 'Jackson', 'mjackson', 'mjackson@harvard.edu', '$2y$10$I1Oqx7pUjw4pnNwyHdmNCOUwxegDlXQ2eG.hZvVEEUAyCatfFVl2K', 'no', '2018-03-14 01:28:58', 227),
(41, 'Rik', 'Smit', 'rSmit', 'rsmit@harvard.edu', '$2y$10$pA/Na9UPB/mooxJGBymzreqFHFauFWldFQm4JEWiL2srCqV0APF4W', 'no', '2018-03-14 01:29:46', 227),
(42, 'Bartolo', 'Colon', 'bColon', 'bColon@harvard.edu', '$2y$10$PB1vdkVOc0aX.lcwzWM5Ce3sNxDHp4xnFNk0QfBhXSMYb3iHi9uWG', 'no', '2018-03-14 17:23:54', 227),
(43, 'Jim', 'Halper', 'jhalper', 'jhalper@harvard.edu', '$2y$10$JP0SaA8DngHpZiZlfklE0ebl25m885yHHZfCx57OXTuIZ.9NUr9OG', 'no', '2018-03-14 17:46:32', 227),
(44, 'Dwight', 'Schrute', 'schrutefarms', 'dschrute@harvard.edu', '$2y$10$OZEIhBCqdr6g2T9UQZitzOTGOQn3h9WwnZE0DVaHdkQifCl63xsT2', 'no', '2018-03-14 17:48:17', 227),
(45, 'Michael', 'Jackson', 'mjackson1', 'mj1@harvard.edu', '$2y$10$7H9gMKLO0bbrdhX8Qvs2q.pw9Q2DCi0YXF85IYydgfwxY/knU8BhC', 'no', '2018-03-18 20:54:16', 227),
(46, 'Josh', 'Hendrick', 'jhendrick', 'jh@harvard.edu', '$2y$10$7p7H7NM.dx/tVbm.RmPKeOH4Xm8S0pR3AHj8W/DpyIC3iiZOJBTpe', 'no', '2018-03-18 20:56:30', 227),
(47, 'Luis', 'Felix', 'lfeliz', 'lfelix@harvard.edu', '$2y$10$k/asIv022.uPVjHudPra6Oxa/tUOurZeAcEWum4a35shNSmHPekfW', 'no', '2018-03-25 03:05:17', 227);
...
(98, 24, 35, 1, NULL, '2018-05-08 15:46:27'),
...
INSERT INTO `c_discussion_replies` (`c_discussion_reply_id`, `college_id`, `community_id`, `major_id`, `c_discussion_id`, `student_id`, `reply_post`, `post_date`) VALUES
(1, 227, 1, NULL, 2, 37, 'Happens to me all the time in my doorm room. Smh', '2017-12-12 10:19:01'),
(3, 227, NULL, 2, 3, 37, 'Definitely take Intro to Finance with Professor Sternberg', '2018-01-08 11:35:22'),
(11, 227, NULL, 2, 12, 35, 'very hard!', '2018-02-27 19:20:05'),
(13, 227, NULL, NULL, 14, 35, 'hello to you!', '2018-03-13 09:39:51'),
(14, 227, NULL, 2, 12, 42, 'Its hard but very rewarding!', '2018-03-14 13:35:27'),
(15, 227, 1, NULL, 2, 39, 'hello all!', '2018-04-25 11:47:19');
...
INSERT INTO `c_discussion_r_reply` (`r_reply_id`, `c_discussion_reply_id`, `college_id`, `community_id`, `major_id`, `c_discussion_id`, `student_id`, `r_reply_post`, `post_date`) VALUES
(1, 1, 227, 1, NULL, 2, 35, 'So saddddddddddd...........', '2017-12-12 11:32:14'),
(2, 1, 227, 1, NULL, 2, 37, 'I know, right? I\'m officially done making sandwiches. It\'s tv dinners and mac & Cheese till I graduate.', '2017-12-12 11:54:23'),
(3, 3, 227, NULL, 2, 3, 35, 'thank you!!!', '2018-02-10 23:32:24'),
(10, 11, 227, NULL, 2, 12, 42, 'not that hard!', '2018-03-14 13:35:36'),
(11, 1, 227, 1, NULL, 2, 39, 'I love tv dinners!', '2018-05-05 11:58:14');
...
CREATE TABLE `discussion_post` (
  ...
  `discussion_room_id` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `discussion_post` (`d_post_id`, `discussion_room_id`, `d_topic_id`, `college_id`, `student_id`, `discussion_title`, `discussion_post`, `post_date`) VALUES
(1, 1, 23, 227, 35, 'What is your major and why did you pick it?', 'Hello, I\'m looking for some serious feedback as to what your majors are and why did you pick it? I\'m a freshmen at Harvard, and I\'m still undecided what my major is going to be. I\'m leaning towards the sciences but for sure I\'m keeping my options open. I will consider all replies. Thanks!', '2017-12-06 11:59:47'),
(5, 1, 2, 227, 35, 'I love trump!', 'who else loves trump?', '2018-02-14 15:32:16'),
(7, 3, 24, 227, 39, 'awesome', 'we are awesome', '2018-05-17 00:43:57'),
(8, 1, 24, 227, 35, 'financial aid', 'who else has major financial aid?', '2018-05-18 23:50:34');
...
CREATE TABLE `discussion_room` (
  `discussion_room_id` int(10) UNSIGNED NOT NULL,
  `discussion_room` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `discussion_room` (`discussion_room_id`, `discussion_room`) VALUES
(1, 'community'),
(2, 'freshmen'),
(3, 'undergrads'),
(4, 'grad_students'),
...
INSERT INTO `discussion_r_replies` (`r_reply_id`, `d_reply_id`, `college_id`, `discussion_id`, `student_id`, `r_reply_post`, `post_date`) VALUES
(1, 1, 227, 1, 35, 'Thanks so much for your reply. Computer Science was on my list. Will def keep my options open!', '2017-12-14 11:43:01'),
(2, 1, 227, 1, 37, 'No Problem. Join the a CS community on here if you want to connect with CS nerds.', '2017-12-14 11:43:01'),
(31, 8, 227, 1, 35, 'Thanks!', '2018-03-19 09:22:49');
...
INSERT INTO `event_comments` (`e_comment_id`, `college_id`, `community_id`, `event_id`, `student_id`, `comment`, `post_date`) VALUES
(1, 227, 1, 4, 35, 'This is exactly what I need :-)', '2017-12-13 12:10:22'),
(14, 227, NULL, 6, 35, 'Sick!', '2018-03-30 09:47:18'),
(15, 227, 1, 4, 39, 'coffeee lifeee', '2018-05-16 16:52:15'),
(16, 227, 1, 4, 39, '', '2018-05-27 00:11:50');
...
CREATE TABLE `majors` (
  ...
  `community_message` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `majors` (`major_id`, `majorList_id`, `college_id`, `category_id`, `community_name`, `community_message`) VALUES
(2, 210, 227, 23, 'Finance', 'Connect and discuss anything with Finance Majors @Harvard. '),
(3, 242, 227, 23, 'Marketing', 'Connect and discuss the latest topics and trends with Marketing majors @Harvard University'),
(4, 832, 227, 23, 'Criminal Justice/Law Enforcement', 'Connect and discuss the latest topics and trends with Criminal Justice/Law Enforcement Administration majors @Harvard University'),
(5, 150, 354, 23, 'Microbiology and Immunology', 'Connect and discuss the latest topics and trends with Microbiology and Immunology majors @Northern Arizona University'),
(6, 292, 227, 23, 'Computer Science', 'Connect and discuss the latest topics and trends with Computer Science majors @Harvard University');

-- --------------------------------------------------------

--
-- Table structure for table `majorsLists`
--

CREATE TABLE `majorsLists` (
  `majorList_id` int(10) UNSIGNED NOT NULL,
  `major` varchar(256) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `majorsLists`
--

INSERT INTO `majorsLists` (`majorList_id`, `major`) VALUES
(1, 'Animal Training'),
...
CREATE TABLE `profile_about_me` (
  ...
  `grad_year` varchar(32) DEFAULT NULL,
...
(2, 210, 35, 'Avid fan of the New England Patriots, Lover of all things coffee...', 'Male', 'Cranston,RI', 'Alumni(2014)', 'Harvad was the best choice I\'ve ever made. Extremely competitive and intellectually challenging', 'Investment Theory and Applications', 'It was an easy decision once I got accepted.'),
...
ALTER TABLE `community_discussions`
  ...
  ADD KEY `community_discussions_ibfk_4` (`college_id`);
...
ALTER TABLE `c_discussion_replies`
  ...
  ADD KEY `c_discussion_replies_ibfk_3` (`c_discussion_id`),
  ADD KEY `c_discussion_replies_ibfk_2` (`community_id`),
  ADD KEY `c_discussion_replies_ibfk_4` (`student_id`),
  ADD KEY `c_discussion_replies_ibfk_5` (`major_id`);
...
ALTER TABLE `c_discussion_r_reply`
  ...
  ADD KEY `c_discussion_r_reply_ibfk_1` (`c_discussion_reply_id`),
  ADD KEY `c_discussion_r_reply_ibfk_2` (`college_id`),
  ADD KEY `c_discussion_r_reply_ibfk_4` (`c_discussion_id`),
  ADD KEY `c_discussion_r_reply_ibfk_3` (`community_id`),
  ADD KEY `c_discussion_r_reply_ibfk_5` (`student_id`),
  ADD KEY `c_discussion_r_reply_ibfk_6` (`major_id`);
...
ALTER TABLE `discussion_post`
  ...
  ADD KEY `discussion_post_ibfk_1` (`discussion_room_id`),
...
ALTER TABLE `discussion_replies`
  ...
  ADD KEY `discussion_replies_ibfk_3` (`college_id`),
...
ALTER TABLE `discussion_r_replies`
  ADD PRIMARY KEY (`r_reply_id`),
  ADD KEY `discussion_r_replies_ibfk_8` (`discussion_id`),
  ADD KEY `discussion_r_replies_ibfk_6` (`d_reply_id`),
  ADD KEY `discussion_r_replies_ibfk_7` (`college_id`),
...
ALTER TABLE `event_comments`
  ...
  ADD KEY `event_comments_ibfk_1` (`college_id`),
...
--
-- Indexes for table `majorsLists`
--
ALTER TABLE `majorsLists`
...
--
ALTER TABLE `community_discussions`
  MODIFY `c_discussion_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `community_discussion_vote`
--
ALTER TABLE `community_discussion_vote`
  MODIFY `c_vote_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `community_members`
--
ALTER TABLE `community_members`
  MODIFY `community_member_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT for table `c_discussion_replies`
--
ALTER TABLE `c_discussion_replies`
  MODIFY `c_discussion_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `c_discussion_r_reply`
--
ALTER TABLE `c_discussion_r_reply`
  MODIFY `r_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `discussion_post`
--
ALTER TABLE `discussion_post`
  MODIFY `d_post_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `discussion_replies`
--
ALTER TABLE `discussion_replies`
  MODIFY `d_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `discussion_room`
--
ALTER TABLE `discussion_room`
  MODIFY `discussion_room_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `discussion_r_replies`
--
ALTER TABLE `discussion_r_replies`
  MODIFY `r_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `discussion_topics`
--
ALTER TABLE `discussion_topics`
  MODIFY `discussion_topic_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `discussion_vote`
--
ALTER TABLE `discussion_vote`
  MODIFY `vote_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `event_comments`
  MODIFY `e_comment_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `favorites`
  MODIFY `favorite_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
--
...
--
ALTER TABLE `interests`
  MODIFY `interest_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
...
--
-- AUTO_INCREMENT for table `majorsLists`
--
ALTER TABLE `majorsLists`
...
--
ALTER TABLE `school_followers`
  MODIFY `school_follower_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `collegestudent`
  ADD CONSTRAINT `collegestudent_ibfk_2` FOREIGN KEY (`collegeId`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `communities`
  ...
  ADD CONSTRAINT `communities_ibfk_4` FOREIGN KEY (`creator_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `community_admins`
  ...
  ADD CONSTRAINT `community_admins_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `community_discussions`
  ...
  ADD CONSTRAINT `community_discussions_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `community_discussions_ibfk_4` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `community_discussion_vote`
  ...
  ADD CONSTRAINT `community_discussion_vote_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `community_members`
  ...
  ADD CONSTRAINT `community_members_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `c_discussion_replies`
--
ALTER TABLE `c_discussion_replies`
  ADD CONSTRAINT `c_discussion_replies_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `c_discussion_replies_ibfk_2` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `c_discussion_replies_ibfk_4` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `c_discussion_replies_ibfk_5` FOREIGN KEY (`major_id`) REFERENCES `majors` (`major_id`) ON DELETE SET NULL;

--
-- Constraints for table `c_discussion_r_reply`
--
ALTER TABLE `c_discussion_r_reply`
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_3` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_5` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_6` FOREIGN KEY (`major_id`) REFERENCES `majors` (`major_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `discussion_post`
--
ALTER TABLE `discussion_post`
  ADD CONSTRAINT `discussion_post_ibfk_1` FOREIGN KEY (`discussion_room_id`) REFERENCES `discussion_room` (`discussion_room_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `discussion_post_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `discussion_post_ibfk_3` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `discussion_replies`
  ADD CONSTRAINT `discussion_replies_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `discussion_replies_ibfk_3` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `discussion_replies_ibfk_6` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `discussion_r_replies`
  ...
  ADD CONSTRAINT `discussion_r_replies_ibfk_2` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `discussion_r_replies_ibfk_4` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `discussion_r_replies_ibfk_7` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `discussion_r_replies_ibfk_9` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `discussion_vote`
  ...
  ADD CONSTRAINT `discussion_vote_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `events`
  ...
  ADD CONSTRAINT `events_ibfk_3` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `event_attendees`
  ...
  ADD CONSTRAINT `event_attendees_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `event_comments`
--
ALTER TABLE `event_comments`
  ADD CONSTRAINT `event_comments_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `event_comments_ibfk_2` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `event_comments_ibfk_3` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `friend_followers`
  ADD CONSTRAINT `friend_followers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `collegestudent` (`id`),
  ADD CONSTRAINT `friend_followers_ibfk_2` FOREIGN KEY (`friend_id`) REFERENCES `collegestudent` (`id`);
...
ALTER TABLE `interests`
  ...
  ADD CONSTRAINT `interests_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `profile_about_me`
  ADD CONSTRAINT `profile_about_me_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `collegeStudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_11` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `school_followers`
  ADD CONSTRAINT `school_followers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `collegestudent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
