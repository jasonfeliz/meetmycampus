...
$communityColor = $categoryId = $communityName = $communityMessage = $communityType = "";
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = create_community($collegeId,$categoryId,$userId,$communityName,$communityMessage,$communityDescription,$communityType,$communityColor);
    if ($result) {
