                              ...
                              <div>
                                ...
                                <div>
                                    ...
                                    <select name="event-type">
                                        ...
                                        <option value="1">Communities</option>
                                        <option value="2">Recreation + Sports</option>
                                        <option value="3">Academics + Career</option>
                                        <option value="4">Student Life</option>
                                        <option value="5">Local Events</option>
                                        <option value="6">Meetups</option>
                                    </select>
