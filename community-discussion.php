									...
									<ul class="forum-list" id="show-replies">
										...
										if (!empty($replies)) {
											foreach ($replies as $key) {
												...
												$content = '<li class="forum-item"  id="c_reply_'.$key['c_discussion_reply_id'].'">';
