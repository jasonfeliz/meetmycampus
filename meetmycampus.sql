...
(21, 'Campus Rants', 'rants-thumbnail'),
...
(34, 'ae', 'arkhamasylum', 'asf', 'sadfsSD!@jwu.edu', '$2y$10$zuZCSVEgJ21JN8rRMF.2W.byXwra0q3zTJO5s6vxVPEc11Sos/iWi', 'yes', '2017-11-22 02:36:17', 262),
(35, 'jason', 'feliz', 'arkham', 'arkham@harvard.edu', '$2y$10$RJ.P.sT2yjmDDX9l2dSw7.E/GTgm6ePiXPg7dp8W1RPx17z94YqYm', 'yes', '2017-11-22 02:38:40', 227),
...
CREATE TABLE `communities` (
  ...
  `community_description` varchar(512) DEFAULT NULL,
  `community_category` varchar(32) DEFAULT NULL,
  `community_type` varchar(32) DEFAULT NULL,
  `community_photo` varchar(128) DEFAULT NULL,
...
INSERT INTO `communities` (`community_id`, `college_id`, `category_id`, `creator_id`, `community_name`, `community_message`, `community_description`, `community_category`, `community_type`, `community_photo`, `date_created`) VALUES
(1, 227, 20, 35, 'Ross\'s Sandwich', 'Welcome to the community dedicated to save Ross\' Sandwich', 'Saving many sandwiches', 'group', 'public', 'blank', '2017-12-03 15:05:59');
...
CREATE TABLE `community_admins` (
  ...
  `is_creator` varchar(10) DEFAULT 'no',
...
INSERT INTO `community_admins` (`admin_id`, `community_id`, `student_id`, `is_creator`, `date_added`) VALUES
(2, 1, 35, 'yes', '2017-12-10 13:26:50');
...
INSERT INTO `community_discussions` (`c_discussion_id`, `community_id`, `student_id`, `c_discussion_post`, `photo`, `date_created`) VALUES
(1, 1, 35, 'Who else has had to deal with people stealing your sandswich at work? Especially the most amazing thanksgiving sandhwich....smh', NULL, '2017-12-10 08:31:02'),
...
INSERT INTO `community_members` (`community_member_id`, `community_id`, `student_id`, `date_joined`) VALUES
(2, 1, 35, '2017-12-10 00:59:09'),
(3, 1, 37, '2017-12-14 22:29:52');
...
INSERT INTO `c_discussion_replies` (`c_discussion_reply_id`, `college_id`, `community_id`, `c_discussion_id`, `student_id`, `reply_post`, `post_date`) VALUES
(1, 227, 1, 2, 37, 'Happens to me all the time in my doorm room. Smh', '2017-12-12 10:19:01');
...
INSERT INTO `c_discussion_r_reply` (`r_reply_id`, `c_discussion_reply_id`, `college_id`, `community_id`, `c_discussion_id`, `student_id`, `r_reply_post`, `post_date`) VALUES
(1, 1, 227, 1, 2, 35, 'So saddddddddddd...........', '2017-12-12 11:32:14'),
(2, 1, 227, 1, 2, 37, 'I know, right? I\'m officially done making sandwiches. It\'s tv dinners and mac & Cheese till I graduate.', '2017-12-12 11:54:23');
...
(3, 6, 227, 35, NULL, 'public', 'Coffee and Study', 'Who wants to meetup for coffee and study for final exams. Leave comments below or DM me', 'Starbucks on Mass Ave.', '', '2017-12-08', '06:00:00', '', '2017-12-08 09:49:38'),
...
CREATE TABLE `event_type` (
  ...
  `event_type_photo` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(403, 'Psychology Teacher Education'),
...
INSERT INTO `profile_about_me` (`profile_id`, `major_id`, `student_id`, `about`, `gender`, `location`, `race`, `grad_year`, `question_1`, `question_2`, `question_3`) VALUES
(2, 210, 35, 'Avid fan of the New England Patriots, Lover of all things coffee...', 'Male', 'Cranston,RI', 'Hispanic', 'Alumni(2014)', 'Harvad was the best choice I\'ve ever made. Extremely competitive and intellectually challenging', 'Investment Theory and Applications', 'It was an easy decision once I got accepted.');
...
ALTER TABLE `majors`
  ...
  ADD KEY `college_id` (`college_id`),
  ADD KEY `category_id` (`category_id`),
  ADD KEY `majorList_id` (`majorList_id`);
...
ALTER TABLE `reviews`
  ...
  ADD KEY `college_id` (`college_id`),
  ADD KEY `review_category_id` (`review_category_id`),
  ADD KEY `review_rating_id` (`review_rating_id`),
  ADD KEY `student_id` (`student_id`);
...
--
ALTER TABLE `communities`
  MODIFY `community_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `community_discussions`
  MODIFY `c_discussion_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `community_members`
--
ALTER TABLE `community_members`
  MODIFY `community_member_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `c_discussion_replies`
--
ALTER TABLE `c_discussion_replies`
  MODIFY `c_discussion_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `c_discussion_r_reply`
--
ALTER TABLE `c_discussion_r_reply`
  MODIFY `r_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `discussion_post`
--
ALTER TABLE `discussion_post`
  MODIFY `d_post_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `discussion_replies`
--
ALTER TABLE `discussion_replies`
  MODIFY `d_reply_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `event_attendees`
  MODIFY `event_attendee_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `event_comments`
--
ALTER TABLE `event_comments`
  MODIFY `e_comment_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `majorsLists`
  MODIFY `majorList_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1222;
--
...
--
ALTER TABLE `reviews_categories`
  MODIFY `review_category_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `collegestudent`
  ADD CONSTRAINT `collegestudent_ibfk_2` FOREIGN KEY (`collegeId`) REFERENCES `collegeList` (`college_id`);

--
-- Constraints for table `communities`
--
ALTER TABLE `communities`
  ADD CONSTRAINT `communities_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `communities_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`),
  ADD CONSTRAINT `communities_ibfk_4` FOREIGN KEY (`creator_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `community_admins`
--
ALTER TABLE `community_admins`
  ADD CONSTRAINT `community_admins_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`),
  ADD CONSTRAINT `community_admins_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `community_discussions`
--
ALTER TABLE `community_discussions`
  ADD CONSTRAINT `community_discussions_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`),
  ADD CONSTRAINT `community_discussions_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);
...
ALTER TABLE `community_members`
  ...
  ADD CONSTRAINT `community_members_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);
...
ALTER TABLE `c_discussion_replies`
  ...
  ADD CONSTRAINT `c_discussion_replies_ibfk_2` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`),
  ADD CONSTRAINT `c_discussion_replies_ibfk_3` FOREIGN KEY (`c_discussion_id`) REFERENCES `community_discussions` (`c_discussion_id`),
  ADD CONSTRAINT `c_discussion_replies_ibfk_4` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `c_discussion_r_reply`
--
ALTER TABLE `c_discussion_r_reply`
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_1` FOREIGN KEY (`c_discussion_reply_id`) REFERENCES `c_discussion_replies` (`c_discussion_reply_id`),
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_2` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_3` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`),
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_4` FOREIGN KEY (`c_discussion_id`) REFERENCES `community_discussions` (`c_discussion_id`),
  ADD CONSTRAINT `c_discussion_r_reply_ibfk_5` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `discussion_post`
--
ALTER TABLE `discussion_post`
  ADD CONSTRAINT `discussion_post_ibfk_1` FOREIGN KEY (`discussion_room_id`) REFERENCES `discussion_room` (`discussion_room_id`),
  ADD CONSTRAINT `discussion_post_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`),
  ADD CONSTRAINT `discussion_post_ibfk_3` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`);

--
-- Constraints for table `discussion_replies`
--
ALTER TABLE `discussion_replies`
  ADD CONSTRAINT `discussion_replies_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `discussion_replies_ibfk_3` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `discussion_replies_ibfk_5` FOREIGN KEY (`discussion_id`) REFERENCES `discussion_post` (`d_post_id`),
  ADD CONSTRAINT `discussion_replies_ibfk_6` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `discussion_r_replies`
--
ALTER TABLE `discussion_r_replies`
  ADD CONSTRAINT `discussion_r_replies_ibfk_1` FOREIGN KEY (`d_reply_id`) REFERENCES `discussion_replies` (`d_reply_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_2` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_3` FOREIGN KEY (`d_reply_id`) REFERENCES `discussion_replies` (`d_reply_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_4` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_5` FOREIGN KEY (`discussion_id`) REFERENCES `discussion_post` (`d_post_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_6` FOREIGN KEY (`d_reply_id`) REFERENCES `discussion_replies` (`d_reply_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_7` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_8` FOREIGN KEY (`discussion_id`) REFERENCES `discussion_post` (`d_post_id`),
  ADD CONSTRAINT `discussion_r_replies_ibfk_9` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);
...
ALTER TABLE `events`
  ...
  ADD CONSTRAINT `events_ibfk_2` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `events_ibfk_3` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`),
  ADD CONSTRAINT `events_ibfk_4` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`);

--
-- Constraints for table `event_attendees`
--
ALTER TABLE `event_attendees`
  ADD CONSTRAINT `event_attendees_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`),
  ADD CONSTRAINT `event_attendees_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `event_comments`
--
ALTER TABLE `event_comments`
  ADD CONSTRAINT `event_comments_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `event_comments_ibfk_2` FOREIGN KEY (`community_id`) REFERENCES `communities` (`community_id`),
  ADD CONSTRAINT `event_comments_ibfk_3` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`),
  ADD CONSTRAINT `event_comments_ibfk_4` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`);

--
-- Constraints for table `interests`
--
ALTER TABLE `interests`
  ADD CONSTRAINT `interests_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`),
  ADD CONSTRAINT `interests_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`);

--
-- Constraints for table `majors`
--
ALTER TABLE `majors`
  ADD CONSTRAINT `majors_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `majors_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`),
  ADD CONSTRAINT `majors_ibfk_3` FOREIGN KEY (`majorList_id`) REFERENCES `majorsLists` (`majorList_id`);

--
-- Constraints for table `profile_about_me`
--
ALTER TABLE `profile_about_me`
  ADD CONSTRAINT `profile_about_me_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `collegeStudent` (`id`),
  ADD CONSTRAINT `profile_about_me_ibfk_2` FOREIGN KEY (`major_id`) REFERENCES `majorsLists` (`majorList_id`);
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `reviews_ibfk_10` FOREIGN KEY (`review_rating_id`) REFERENCES `review_ratings` (`rating_id`),
  ADD CONSTRAINT `reviews_ibfk_11` FOREIGN KEY (`student_id`) REFERENCES `collegestudent` (`id`),
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`review_category_id`) REFERENCES `reviews_categories` (`review_category_id`),
  ADD CONSTRAINT `reviews_ibfk_3` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `reviews_ibfk_4` FOREIGN KEY (`review_category_id`) REFERENCES `reviews_categories` (`review_category_id`),
  ADD CONSTRAINT `reviews_ibfk_5` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `reviews_ibfk_6` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `reviews_ibfk_7` FOREIGN KEY (`review_category_id`) REFERENCES `reviews_categories` (`review_category_id`),
  ADD CONSTRAINT `reviews_ibfk_8` FOREIGN KEY (`college_id`) REFERENCES `collegeList` (`college_id`),
  ADD CONSTRAINT `reviews_ibfk_9` FOREIGN KEY (`review_category_id`) REFERENCES `reviews_categories` (`review_category_id`);
COMMIT;
